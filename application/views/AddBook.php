...
<html>
    ...
    <body>
        ...
        <div class="alert alert-danger container" style="padding-top:80px">
            ...
            <?php } ?>
        <?php echo form_open_multipart('Book_Controller/do_add',array('class'=>'container','style'=>'padding-top:80px')) ?>
            <div class="row">
                <!-- ảnh của sách -->
                <div class="col-3 bg-light">
                    <div class="card" >
                        <img class="card-img-top img-fluid" src="<?php echo base_url() . '/images/book/BOOK_0.jpg'; ?>" alt="Card image">
                    </div>
                    <hr>
                ...
                <div class="col-8 bg-light">
                    ...
                    <div class='form-group row justify-content-end my-2 g'>
                        ...
                        <div class='col-8  my-2'>
                            <span><strong>Lựa chọn: </strong></span> 
